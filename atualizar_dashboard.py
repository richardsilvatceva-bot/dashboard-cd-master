...
# ==========================================
# 🚨 GERE UM NOVO TOKEN NO GITHUB E COLE AQUI DENTRO DAS ASPAS:
GITHUB_TOKEN = "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"
...
def gerar_json():
    ...
    # 6. SOBRAS (CORREÇÃO DE EXTRAÇÃO DA SEGUNDA TABELA)
        ...
        if header_1 != -1:
            ...
            for r in range(header_1 + 1, len(df_sobras)):
                ...
                if curr_st != 'RESGATADO':
                    sobras_dados.append({"status": curr_st, "marca": curr_mc, "locacoes": int(loc_val), "valor": val_val})

        # Tabela 2: Lado Direito
        header_2 = -1
    ...
    try:
        ...
        payload = {
            "message": "Atualização automática Final 🚀", 
